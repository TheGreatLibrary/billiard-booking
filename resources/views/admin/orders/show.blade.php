        ...
        <div class="bg-white rounded-lg shadow-md p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <p class="mt-1 text-xl font-bold text-gray-900">{{ number_format($order->total_amount, 2) }} ₽</p>
                </div>
                <div>
                ...
                <table class="w-full">
                    ...
                    <tbody class="divide-y divide-gray-200">
                        ...
                        <tr>
                            ...
                            <td class="px-4 py-3 text-sm font-medium text-gray-900">{{ number_format($item->quantity * $item->price, 2) }} ₽</td>
                        </tr>
                        @endforeach
                    </tbody>
                    <tfoot class="bg-gray-50">
                        <tr>
                            ...
                            <td class="px-4 py-3 text-sm font-bold text-gray-900">{{ number_format($order->total_amount, 2) }} ₽</td>
                        </tr>
                    </tfoot>
                </table>
            </div>
