...
@section('content')
<div class="container">
    <h1>Добавить модель продукта</h1>
    <form method="POST" action="{{ route('admin.product-models.store') }}">
        @csrf
        ...
        <div class="mb-3">
            ...
            <input type="number" name="base_price_hour" class="form-control" value="{{ old('base_price_hour') }}">
        ...
        <div class="mb-3">
            ...
            <input type="number" name="base_price_each" class="form-control" value="{{ old('base_price_each') }}">
